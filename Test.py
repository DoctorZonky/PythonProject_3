...
if fasta_file_on:
    ...
    if FASTA_file is not None:
        ...
        fasta_obj_file = FASTA_file.getvalue().decode("utf-8")                                              # Die Datei wird in einen String umgewandelt
        header = FASTA(fasta_obj_file).header_input()                                                       # Erstellen eines Objekts der Klasse FASTA und Aufruf der Methode zum Aufreinigen des Headers
        ...
        sequence_native = FASTA(fasta_obj_file).sequence_input()                                            # Erstellen eines Objekts der Klasse FASTA und Aufruf der Methode zum Aufreinigen des Textes
